...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.BookViewHolder> {
    public ArrayList<Book> bookList;
    public Context activity;

    public HomeAdapter(ArrayList<Book> bList, Context context){   // getting bookList to the adapter (constructor)
        this.bookList = bList;
